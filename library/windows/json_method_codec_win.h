...
// the jsoncpp library).
class JsonMethodCodecWin : public MethodCodec {
 public:
  // Returns the shared instance of the codec.
  static const JsonMethodCodecWin &GetInstance();

  ~JsonMethodCodecWin() = default;

  // Prevent copying.
  JsonMethodCodecWin(JsonMethodCodecWin const &) = delete;
  JsonMethodCodecWin &operator=(JsonMethodCodecWin const &) = delete;
