...
if %ANGLEEXISTS%==false (
    PowerShell -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -UseBasicParsing -Uri https://github.com/clarkezone/angle-1/releases/download/0.1.2/libGLESv2.dll.zip -OutFile "%~dp0..\dependencies\libGLESv2.zip
